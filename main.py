...
class TikTokBot:
    ...
    def get_cookies(self):
        ...
        if os.path.exists(f"/absolute_path/{mail}_cookies"):
            ...
            if self.class_exists("login-button"):
                try:
                    ...
                    pickle.dump(
                        ...
                        open(f"/absolute_path/{mail}_cookies", "wb")
                    )
    ...
    def set_like(self, post_url):
        ...
        try:
            ...
            for cookie in pickle.load(
                open(f"/absolute_path/{mail}_cookies", "rb")
            ):
...
def main():
    tiktok_bot = TikTokBot(mail=mail, password=password)
